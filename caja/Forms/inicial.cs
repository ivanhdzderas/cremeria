...
namespace caja
{
    public partial class inicial : Form
    {
        ...
        private void ventaPorClienteDetalladoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string tabName = "R clientes";
            Boolean encontrado = false;
            foreach (TabPage page in Home.TabPages)
            {
                string name = page.Name;
            ...
            if (encontrado == false)
            {
                ...
                Forms.clientes_detallado fc = new Forms.clientes_detallado();
                fc.TopLevel = false;
                fc.Visible = true;
                fc.MdiParent = this;
                fc.FormBorderStyle = FormBorderStyle.None;
        ...
        private void toolStripButton7_Click(object sender, EventArgs e)
        {
            ...
            if (encontrado == false)
            {
                TabPage tpage = new TabPage(tabName);
                tpage.Name = tabName;
                devoluciones fc = new devoluciones();
                fc.TopLevel = false;
                fc.Visible = true;
